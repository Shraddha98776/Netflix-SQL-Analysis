...
| 10 | Find each year and avg content release in India — return top 5 years |
...
\- \*\*6,131 Movies\*\* vs \*\*2,676 TV Shows\*\* exist in the Netflix library

\- \*\*TV-MA\*\* and \*\*TV-14\*\* are the most common content ratings

\- \*\*USA, India, and UK\*\* are the top 3 content-producing countries

\- Content categorized as \*\*'Bad'\*\* (containing keywords 'kill' or 'violence') was identified using CASE statements

\- \*\*Top 10 Indian actors\*\* identified by parsing the cast column using string functions
...
\- `WHERE`, `LIKE`, `IN`, `IS NULL`, `BETWEEN`

\- `CASE` statements for conditional categorization

\- String functions — `SUBSTRING\_INDEX`, `TRIM`, `ILIKE`

\- Date functions — `DATEDIFF`, `CURRENT\_DATE`, `EXTRACT`
...
├── netflix\_titles.csv       # Raw dataset (8,088 records)

├── netflix\_analysis.sql     # All 15 business problem queries
